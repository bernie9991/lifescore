...
BEGIN
  ...
  DROP TRIGGER IF EXISTS update_wealth_data_updated_at ON wealth_data;
  DROP TRIGGER IF EXISTS update_knowledge_data_updated_at ON knowledge_data;
...
CREATE INDEX IF NOT EXISTS idx_wealth_data_user_id ON wealth_data(user_id);
CREATE INDEX IF NOT EXISTS idx_knowledge_data_user_id ON knowledge_data(user_id);
CREATE INDEX IF NOT EXISTS idx_assets_user_id ON assets(user_id);
CREATE INDEX IF NOT EXISTS idx_user_badges_user_id ON user_badges(user_id);
CREATE INDEX IF NOT EXISTS idx_friendships_user_id ON friendships(user_id);
CREATE INDEX IF NOT EXISTS idx_friendships_friend_id ON friendships(friend_id);
CREATE INDEX IF NOT EXISTS idx_profiles_life_score ON profiles(life_score DESC);
